...
class PlayState extends MusicBeatState
{
	...
	public var SplashNote:NoteSplash;
	...
	public static var grpNoteSplashes:FlxTypedGroup<NoteSplash>;
	...
	var thagroun2:FlxSprite;
	var thawal2:FlxSprite;

	var thaground:FlxSprite;
	var thawal:FlxSprite;
	...
	public static var estilo2:String = "normal";
	...
	override public function create()
	{
		...
		switch(stageCheck)
		{
				...
				case 'BG':
					{
							defaultCamZoom = 0.9;
							curStage = 'BG';
							var roses:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('SchoolB'));
							roses.antialiasing = true;
							roses.scrollFactor.set(0.9, 0.9);
							roses.active = false;
							add(roses);
					}	
					case 'churchSel':
			{
				...
				var bg = new FlxSprite(-500, -850).loadGraphic(Paths.image('churchSel/bg'));
				...
				var floor:FlxSprite = new FlxSprite(-500, -850).loadGraphic(Paths.image('churchSel/floor'));
				...
				var pillars:FlxSprite = new FlxSprite(-500, -850).loadGraphic(Paths.image('churchSel/pillars'));
			...
			case 'stage2':
				{
						defaultCamZoom = 0.9;
						curStage = 'stage2';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stage2/stageback3'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
	
						var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('stage2/stagefront3'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.scrollFactor.set(0.9, 0.9);
						...
						var stageCurtains:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stage2/stagecurtains3'));
						stageCurtains.setGraphicSize(Std.int(stageCurtains.width * 0.9));
						stageCurtains.updateHitbox();
						stageCurtains.antialiasing = true;
						stageCurtains.scrollFactor.set(1.3, 1.3);
				...
				case 'tank':
					{
							...
							tankBop1 = new FlxSprite(-500, 450);
			...
			case  'better':{
				...
				curStage = 'better';
				    ...
				    thawal= new FlxSprite(-870, -360).loadGraphic(Paths.image('UnderGround/thawal'));
				    thawal.setGraphicSize(Std.int(thawal.width * 1.1));
				    thawal.updateHitbox();
				    thawal.antialiasing = true;
				    thawal.scrollFactor.set(0.9, 0.9);
					
					add(thawal);

				    thaground = new FlxSprite( -600, -450).loadGraphic(Paths.image('UnderGround/thagroun'));
				    thaground.setGraphicSize(Std.int(thaground.width * 1.1));
				    thaground.updateHitbox();
					thaground.antialiasing = true;
					thaground.scrollFactor.set(1, 1);

					add(thaground);

					thawal2 = new FlxSprite(-870, -360);
					thawal2.frames = Paths.getSparrowAtlas('UnderGround/tha_swag_wal');
					thawal2.setGraphicSize(Std.int(thawal2.width * 1.1));
					thawal2.alpha = 0;
					thawal2.updateHitbox();
					thawal2.animation.addByPrefix('idle','wal style change0', 24, false);
					thawal2.animation.play('idle');
					thawal2.antialiasing = true;
					thawal2.scrollFactor.set(0.9, 0.9);
					add(thawal2);
					
					thagroun2 = new FlxSprite( -600, -450);
					thagroun2.frames = Paths.getSparrowAtlas('UnderGround/tha_cool_groun');
					thagroun2.setGraphicSize(Std.int(thagroun2.width * 1.1));
					thagroun2.updateHitbox();
					thagroun2.alpha = 0;
					thagroun2.animation.addByPrefix('idle','flo style change0', 24, false);
					thagroun2.animation.play('idle');
					thagroun2.antialiasing = true;
					thagroun2.scrollFactor.set(1, 1);
					add(thagroun2);

					if (songLowercase == 'undergroundb' ){
		...
		if (SONG.gfVersion == null) {
			switch(storyWeek)
			{
				...
				case 7: gfCheck = 'gfbunny';
				case 8: gfCheck = 'gf-tankman';
				case 9: gfCheck = 'gf_JUICY';
				case 10: gfCheck = 'gfunder2';
			}
		...
		botPlayState = new FlxText(healthBarBG.x + healthBarBG.width / 2 - 75, healthBarBG.y + (PlayStateChangeables.useDownscroll ? 100 : -100), 0, "Doggy_Modder_Play", 20);
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			if (SONG.noteStyle == null) {
				switch(storyWeek) {case 6: noteTypeCheck = 'pixel'; estilo2 = "pixel";
				default: SONG.noteStyle = "normal";}
			} else {noteTypeCheck = SONG.noteStyle; estilo2 = SONG.noteStyle;}
				...
				case 'pixel':
					...
					case 'normal':
						...
						switch (Math.abs(i))
						{
							...
							case 'BenNotes':
								babyArrow.frames = Paths.getSparrowAtlas('Notes/Benjamin_NOTE_assets');
								babyArrow.animation.addByPrefix('green', 'arrowUP');
								babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
								babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
								babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
							...
							case 'Doki':
								babyArrow.frames = Paths.getSparrowAtlas('Notes/Doki_Doki_NOTE_assets');
								babyArrow.animation.addByPrefix('green', 'arrowUP');
								babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
								babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
								babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
								...
								case 'Tabi':
									babyArrow.frames = Paths.getSparrowAtlas('Notes/EX_NOTE_assets');
								    babyArrow.animation.addByPrefix('green', 'arrowUP');
									babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
									babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
									babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
									...
									case 'Masses':
										babyArrow.frames = Paths.getSparrowAtlas('Notes/Masses_NOTE_assets');
										babyArrow.animation.addByPrefix('green', 'arrowUP');
										babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
										babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
										babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
										...
										case 'Entity':
										babyArrow.frames = Paths.getSparrowAtlas('Notes/Entity_NOTE_assets');
										babyArrow.animation.addByPrefix('green', 'arrowUP');
										babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
										babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
										babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
										...
										case 'Washi':
											babyArrow.frames = Paths.getSparrowAtlas('Notes/Washi_NOTE_assets');
											babyArrow.animation.addByPrefix('green', 'arrowUP');
											babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
											babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
											babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
											...
											case 'Ace':
												babyArrow.frames = Paths.getSparrowAtlas('Notes/NOTE_assets_Ace');
												babyArrow.animation.addByPrefix('green', 'arrowUP');
												babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
												babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
												babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
												...
												case 'Retro':
												babyArrow.frames = Paths.getSparrowAtlas('Notes/NOTE_assets_Retro');
												babyArrow.animation.addByPrefix('green', 'arrowUP');
												babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
												babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
												babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
												...
												case 'Kapi':
												babyArrow.frames = Paths.getSparrowAtlas('Notes/Arcade_NOTE_assets');
												babyArrow.animation.addByPrefix('green', 'arrowUP');
												babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
												babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
												babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
												...
												case 'Pico':
												babyArrow.frames = Paths.getSparrowAtlas('Notes/Pico_School_NOTE_assets');
												babyArrow.animation.addByPrefix('green', 'arrowUP');
												babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
												babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
												babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
												...
												case 'Taki':
													babyArrow.frames = Paths.getSparrowAtlas('Notes/Taki_NOTE_assets');
													babyArrow.animation.addByPrefix('green', 'arrowUP');
													babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
													babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
													babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
													...
													case 'Hololive':
													babyArrow.frames = Paths.getSparrowAtlas('Notes/Hololive_NOTE_assets');
													babyArrow.animation.addByPrefix('green', 'arrowUP');
													babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
													babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
													babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
													...
													case 'ElicrackNotes':
														babyArrow.frames = Paths.getSparrowAtlas('Notes/Elicrack_NOTE_assets');
														babyArrow.animation.addByPrefix('green', 'arrowUP');
														babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
														babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
														babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
														...
														case 'DoggyNotes':
															babyArrow.frames = Paths.getSparrowAtlas('Notes/Doggy_NOTE_assets');
															babyArrow.animation.addByPrefix('green', 'arrowUP');
															babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
															babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
															babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
															...
															case 'FunNotes':
																babyArrow.frames = Paths.getSparrowAtlas('Notes/Majic_NOTE_assets');
																babyArrow.animation.addByPrefix('green', 'arrowUP');
																babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
																babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
																babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
		...
		if (generatedMusic && PlayState.SONG.notes[Std.int(curStep / 16)] != null)
		{
			...
			if (camFollow.x != dad.getMidpoint().x + 150 && !PlayState.SONG.notes[Std.int(curStep / 16)].mustHitSection)
			{
				...
				switch (dad.curCharacter)
				{
					...
					case 'Whitty'|'piconjo'|'Tabi'|'Ruv'|'MrBeast'|'Lucian':
						camFollow.y = dad.getMidpoint().y;
					case 'HDSenpaiAngry' :
						camFollow.y = dad.getMidpoint().y;
					case 'sarvDark'|'sarv' :
					...
					case 'senpai-angry':
						camFollow.y = dad.getMidpoint().y - 430;
						camFollow.x = dad.getMidpoint().x - 100;
					case 'abbyMad'|'sonicfun':
						camFollow.y = dad.getMidpoint().y + 100;
					case 'AgotiAngry':
						camFollow.y = dad.getMidpoint().y + 100;
					case 'GFHypno':
						camFollow.y = dad.getMidpoint().y + 200;
					case 'WashiAngry'| 'Elicrack'| 'Benjamin'|'Nene'|'Uberkid'|'Ron'|'Eduardo':
						camFollow.y = dad.getMidpoint().x;
			...
			if (PlayState.SONG.notes[Std.int(curStep / 16)].mustHitSection && camFollow.x != boyfriend.getMidpoint().x - 100)
			{
                ...
                switch (boyfriend.curCharacter)
				{
					...
					case'bfbotan':
				        camFollow.x = boyfriend.getMidpoint().x - 100;
				        camFollow.y = boyfriend.getMidpoint().y - 100;
					case'bfdoggy'|'bfmarcos'|'bfannie':
				        camFollow.x = boyfriend.getMidpoint().x - 100;
				        camFollow.y = boyfriend.getMidpoint().y - 25;
					case 'bfhank'|'bftankman'|'bfdarnell'|'bfabby':
						camFollow.x = boyfriend.getMidpoint().x - 100;
				        camFollow.y = boyfriend.getMidpoint().y - 250;
					case'bfnene':
				        camFollow.x = boyfriend.getMidpoint().x - 100;
		...
		if (generatedMusic)
			{
				...
				{	
					...
					if (!daNote.mustPress && daNote.wasGoodHit)
					{
	                    ...
	                    if (dad.curCharacter == 'Selever' && health > 0.05)
							{
								if (daNote.isSustainNote)
									{
										health -= 0.025;
						...
						if (dad.curCharacter == 'WashiAngry' && health > 0.05)
								{
									if (daNote.isSustainNote)
										{
											health -= 0.035;
								...
								if (dad.curCharacter == 'monster' && health > 0.05)
									{
										if (daNote.isSustainNote)
											{
												health -= 0.065;
	...
	function endSong():Void
	{
        ...
        if(achievementObj != null) {
			...
			var achieve:String = unlockAwards(['Rosesb', 'Mic', 'Gunsb', 'Southb', 'SouthR', 'UnderGroundB', 'Picob', 'humilde']);
			if(achieve != null) {
		...
		else
		{
			if (isStoryMode)
			{
				...
				campaignMisses += Math.round(misses);
	...
	*/
	...
	override function stepHit()
	{
		...
		if (curBeat == 965 && SONG.song.toLowerCase() == 'undergroundb')
			{
			    thawal.alpha = 0;
				thaground.alpha = 0;
				thawal2.alpha = 1;
	...
	public function unlockAwards(achievesToCheck:Array<String>) {
		for (i in 0...achievesToCheck.length) {
		var achievementName:String = achievesToCheck[i];
		if(!Awards.isAchievementUnlocked(achievementName)){
		var unlock:Bool = false;
		switch(achievementName)
		{
                 case 'Rosesb'| 'Mic'| 'Gunsb'| 'Southb'| 'SouthR'| 'UnderGroundB'| 'Picob'| 'humilde':
				 if(misses < 1 && CoolUtil.difficultyString() == 'MASTER'){
                    switch(curSong){
						case 'rosesb':
							if(achievementName == 'Rosesb') unlock = true;
							FlxG.save.data.achievementsMap = Awards.achievementsMap;
						case 'Tutorial':
							if(achievementName == 'Mic') unlock = true;
							FlxG.save.data.achievementsMap = Awards.achievementsMap;
						case 'gunsb':
						    if(achievementName == 'Gunsb') unlock = true;
							FlxG.save.data.achievementsMap = Awards.achievementsMap;
						case 'South':
							if(achievementName == 'Southb') unlock = true;
							FlxG.save.data.achievementsMap = Awards.achievementsMap;
						case 'Southremix':
						    if(achievementName == 'SouthR') unlock = true;
							FlxG.save.data.achievementsMap = Awards.achievementsMap;
						case 'undergroundb':
							if(achievementName == 'UnderGroundB') unlock = true;
							FlxG.save.data.achievementsMap = Awards.achievementsMap;
						case 'picob':
						    if(achievementName == 'Picob') unlock = true;
							FlxG.save.data.achievementsMap = Awards.achievementsMap;
						case 'talentlessyt':
						    if(achievementName == 'humilde') unlock = true;
							FlxG.save.data.achievementsMap = Awards.achievementsMap;
					    }
				    }
	            }
			if(unlock) {
				Awards.unlockAchievement(achievementName);
	...
	public function changeStyle(estilo:String, ?modo:Int = 0){
